...
function checkPassword() {
    if(form.password.value.length <= 8) {
        const p = document.querySelector('#center .errore');
        p.textContent = 'La password non ha una lunghezza sufficiente e deve contenere almeno un numero, una lettera maiuscola, una lettera minuscola e un carattere speciale';
        return 0;
    } else {
        return 1;
    }
