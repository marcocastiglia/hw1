...
$query = "SELECT * FROM recipe where id in (SELECT recipe from favoriterecipe where username = '".$_SESSION['username']."') ORDER BY id DESC"; 
...
$query = "SELECT * from ingredients where recipe in 
            ...
            (SELECT recipe from favoriterecipe where username = '".$_SESSION['username']."'))";
